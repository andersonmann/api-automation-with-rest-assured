...
public class CreateSimalationTest extends BaseTest {
    ...
    @Test(priority = 0, description = "Cria uma nova simulacao utilizando os seguinte dados randomizados: cpf(válido), nome, email")
    ...
    @Test(priority = 1, description = "Tenta criar uma nova simulacao utilizando um CPF já existente")
